...
export class BoardService {
  ...
  constructor(){
    ...
    this.board[3][26] = {type: 'GRASS', piece: new Piece('0deg')};
    this.board[9][27] = {type: 'GRASS', piece: new Piece('0deg')};
    this.board[13][29] = {type: 'GRASS', piece: new Piece('0deg')};

    this.board[4][0] = {type: 'GRASS', piece: new Piece('180deg')};
    this.board[7][3] = {type: 'GRASS', piece: new Piece('180deg')};
    this.board[11][4] = {type: 'GRASS', piece: new Piece('180deg')};
  }
